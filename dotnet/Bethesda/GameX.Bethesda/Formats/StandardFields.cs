...
namespace GameX.Bethesda.Formats
{
    ...
    public struct ColorRef3 { public static (string, int) Struct = ("<3c", 3); public byte Red; public byte Green; public byte Blue; public override readonly string ToString() => $"{Red}:{Green}:{Blue}"; }

    [StructLayout(LayoutKind.Sequential, Pack = 1)]
    public struct ColorRef4 { public static (string, int) Struct = ("<4c", 4); public byte Red; public byte Green; public byte Blue; public byte Null; public override readonly string ToString() => $"{Red}:{Green}:{Blue}"; public GXColor32 ToColor32() => new GXColor32(Red, Green, Blue, 255); }
    ...
    public struct STRVField { public string Value; public override readonly string ToString() => Value; }
    public struct FILEField { public string Value; public override readonly string ToString() => Value; }
    public struct INTVField { public static (string, int) Struct = ("<q", 8); public long Value; public override readonly string ToString() => $"{Value}"; public UI16Field ToUI16Field() => new() { Value = (ushort)Value }; }
    public struct DATVField { public bool B; public int I; public float F; public string S; public override readonly string ToString() => "DATV"; }
    public struct FLTVField { public static (string, int) Struct = ("<f", 4); public float Value; public override readonly string ToString() => $"{Value}"; }
    public struct BYTEField { public static (string, int) Struct = ("<c", 1); public byte Value; public override readonly string ToString() => $"{Value}"; }
    public struct IN16Field { public static (string, int) Struct = ("<h", 2); public short Value; public override readonly string ToString() => $"{Value}"; }
    public struct UI16Field { public static (string, int) Struct = ("<H", 2); public ushort Value; public override readonly string ToString() => $"{Value}"; }
    public struct IN32Field { public static (string, int) Struct = ("<i", 4); public int Value; public override readonly string ToString() => $"{Value}"; }
    public struct UI32Field { public static (string, int) Struct = ("<I", 4); public uint Value; public override readonly string ToString() => $"{Value}"; }
    public struct FMIDField<TRecord>(BinaryReader r, int dataSize) where TRecord : Record
    {
        public FormId<TRecord> Value = dataSize == 4 ?
    ...
    public struct BYTVField { public byte[] Value; public override readonly string ToString() => $"BYTS"; }
    public struct UNKNField { public byte[] Value; public override readonly string ToString() => $"UNKN"; }
}