...
namespace GameX.Bethesda.Formats.Records
{
    public unsafe class TES4Record : Record
    {
        ...
        public override bool CreateField(BinaryReader r, BethesdaFormat format, string type, int dataSize)
        {
            switch (type)
            {
                case "HEDR": HEDR = r.ReadSAndVerify<HEDRField>(dataSize); return true;
                ...
                case "INTV": INTV = r.ReadSAndVerify<IN32Field>(dataSize); return true;
                case "INCC": INCC = r.ReadSAndVerify<IN32Field>(dataSize); return true;
                // TES5
