    ...
    public unsafe class LANDRecord : Record
    {
        ...
        public override bool CreateField(BinaryReader r, BethesdaFormat format, string type, int dataSize)
        {
            switch (type)
            {
                ...
                // TES3
                case "INTV": INTV = r.ReadSAndVerify<CORDField>(dataSize); return true;
                case "WNAM": WNAM = new WNAMField(r, dataSize); return true;
                // TES4
                case "BTXT": var btxt = r.ReadSAndVerify<BTXTField>(dataSize); BTXTs[btxt.Quadrant] = btxt; return true;
                case "ATXT":
                    if (ATXTs == null) ATXTs = new ATXTGroup[4];
                    var atxt = r.ReadSAndVerify<BTXTField>(dataSize); _lastATXT = ATXTs[atxt.Quadrant] = new ATXTGroup { ATXT = atxt }; return true;
