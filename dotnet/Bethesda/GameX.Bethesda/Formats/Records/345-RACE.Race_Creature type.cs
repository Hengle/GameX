                ...
                switch (_nameState)
                {
                    case 0:
                        switch (type)
                        {
                            ...
                            case "CNAM": CNAM = r.ReadSAndVerify<BYTEField>(dataSize); return true;
                            case "PNAM": PNAM = r.ReadSAndVerify<FLTVField>(dataSize); return true;
                            case "UNAM": UNAM = r.ReadSAndVerify<FLTVField>(dataSize); return true;
                    ...
                    case 1: // Face Data
                        switch (type)
                        {
                            case "INDX": FaceParts.Add(new FacePartGroup { INDX = r.ReadSAndVerify<UI32Field>(dataSize) }); return true;
                    ...
                    case 2: // Body Data
                        switch (type)
                        {
                            ...
                            case "MODB": Bodys[_genderState].MODB = r.ReadSAndVerify<FLTVField>(dataSize); return true;
                            case "INDX": Bodys[_genderState].BodyParts.Add(new BodyPartGroup { INDX = r.ReadSAndVerify<UI32Field>(dataSize) }); return true;
